...
@section('content')
<div id="safeguard">
    <div id="top" class="bg-custom-primary">
        <div class="top-inner container py-2">
            {{-- <div class="row">
                <div class="col">
                    <!-- Logo Image-->
                    ...
                    @else
                        <h1 class="h1 text-white font-weight-bolder bg-info text-center w-50 py-4 rounded-circle">
            ...
            <div class="row">
                <div class="col">
                    <h4 class="h2 text-uppercase font-weight-bold mb-0 mt-2 text-light">
                        {{ $organisation->name }}
                    </h4>
                    <h4 class="h5 font-weight-bold mb-2 text-light">
